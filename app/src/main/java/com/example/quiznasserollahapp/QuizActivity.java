        ...
        btnNext.setOnClickListener(v -> {
            ...
            if (selectedId == -1) {
                ...
                if (currentQuestion == 1) {
                    if (selectedOption.equals("Wife")) {
                        bloodScore -= 50;
                    }
                }
                if (currentQuestion == 2) {
                    if (selectedOption.equals("Take the wallet to the police.")) {
                        bloodScore -= 50;
                    }
                }
                if (currentQuestion == 3) {
                    if (selectedOption.equals("Ask for help from a local or embassy.")) {
                        bloodScore -= 50;
                    }
                }
                if (currentQuestion == 4) {
                    if (selectedOption.equals("Run to the nearest building for shelter.")) {
                        bloodScore -= 50;
                    }
                }
                if (currentQuestion == 5) {
                    if (selectedOption.equals("Remain calm, press the emergency button, and wait for help.")) {
                        bloodScore -= 50;
                    }
                }
                if (currentQuestion == 6) {
                    if (selectedOption.equals("Alert the authorities and evacuate the area calmly.")) {
                        bloodScore -= 50;
                    }
                }
                if (currentQuestion == 7) {
                    if (selectedOption.equals("An elderly person")) {
                        bloodScore -= 50;
                    }
                }
                ...
                if (currentQuestion == 7) {
                    // Determine the next page based on blood score
                    Intent intent;
                    if (bloodScore < 300) {
                    ...
                    // Pass the final score to the new activity
